...
geturls_opener.addheaders = [("Referer", "http://www.google.com/search?q=younglegalporn"), ("User-Agent", fakeua), ("Accept-Encoding", "gzip, deflate"), ("Accept-Language", "en-US,en-CA,en-GB,en-UK,en-AU,en-NZ,en-ZA,en;q=0.5"),
...
regex_text = re.escape("<li><a href=\"http://photos.younglegalporn.com/") + \
    "([a-fA-F0-9]{8})"+re.escape("/") + \
    "([a-zA-Z0-9]{14})"+re.escape("/\"><img title=\"")
...
while(i < il):
    if(not os.path.exists("./younglegalporn/"+post_text[i][0]+"/")):
        print(str(i+1)+" Making Directory: ./younglegalporn/" +
              post_text[i][0]+"/")
        os.mkdir("./younglegalporn/"+post_text[i][0]+"/")
    getsuburls_cj = geturls_cj
    getsuburls_opener = urllib2.build_opener(
        urllib2.HTTPCookieProcessor(getsuburls_cj))
    getsuburls_opener.addheaders = [("Referer", "http://photos.younglegalporn.com/"), ("User-Agent", fakeua), ("Accept-Encoding", "gzip, deflate"), ("Accept-Language", "en-US,en-CA,en-GB,en-UK,en-AU,en-NZ,en-ZA,en;q=0.5"),
                                    ("Accept-Charset", "ISO-8859-1,ISO-8859-15,utf-8;q=0.7,*;q=0.7"), ("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"), ("Connection", "close")]
    ...
    print(str(i+1)+" Reading Image Gallery: http://photos.younglegalporn.com/" +
          post_text[i][0]+"/"+post_text[i][1]+"/")
    getsuburls_text = getsuburls_opener.open(
        "http://photos.younglegalporn.com/"+post_text[i][0]+"/"+post_text[i][1]+"/")
    ...
    subout_text = subout_text.replace("/pics//", "/pics/")
    subregex_text = re.escape("<a href=\"http://content1.sexforsure.com/")+"([0-9]+)"+re.escape("/")+"([0-9]+)"+re.escape(
        "/")+"([0-9]+)"+re.escape("/")+"([0-9]+)"+re.escape("/pics/")+"([0-9]+)"+re.escape(".jpg\"><img src=\"")
    ...
    while(subi < subil):
        ...
        getsub2xurls_opener.addheaders = [("Referer", "http://photos.younglegalporn.com/"+post_text[i][0]+"/"+post_text[i][1]+"/"), ("User-Agent", fakeua), ("Accept-Encoding", "gzip, deflate"), ("Accept-Language",
                                                                                                                                                                                                   "en-US,en-CA,en-GB,en-UK,en-AU,en-NZ,en-ZA,en;q=0.5"), ("Accept-Charset", "ISO-8859-1,ISO-8859-15,utf-8;q=0.7,*;q=0.7"), ("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"), ("Connection", "close")]
        print(str(i+1)+","+str(subi+1) +
              " Start Downloading Image File: "+str(subi+1)+" of "+str(subil))
        print(str(i+1)+","+str(subi+1)+" Downloading Image: http://content1.sexforsure.com/" +
              subpost_text[subi][0]+"/"+subpost_text[subi][1]+"/"+subpost_text[subi][2]+"/"+subpost_text[subi][3]+"/pics/"+subpost_text[subi][4]+".jpg")
        getsub2xurls_text = getsub2xurls_opener.open(
            "http://content1.sexforsure.com/"+subpost_text[subi][0]+"/"+subpost_text[subi][1]+"/"+subpost_text[subi][2]+"/"+subpost_text[subi][3]+"/pics/"+subpost_text[subi][4]+".jpg")
        print(str(i+1)+","+str(subi+1)+" Finished Downloading Image: http://content1.sexforsure.com/" +
              subpost_text[subi][0]+"/"+subpost_text[subi][1]+"/"+subpost_text[subi][2]+"/"+subpost_text[subi][3]+"/pics/"+subpost_text[subi][4]+".jpg")
        print(str(i+1)+","+str(subi+1)+" Saving File: ./younglegalporn/" +
              post_text[i][0]+"/"+subpost_text[subi][4]+".jpg")
        jpegf = open("./younglegalporn/" +
                     post_text[i][0]+"/"+subpost_text[subi][4]+".jpg", "wb")
        jpegf.write(getsub2xurls_text.read())
        jpegf.close()
        print(str(i+1)+","+str(subi+1)+" Finished Saving File: ./younglegalporn/" +
              post_text[i][0]+"/"+subpost_text[subi][4]+".jpg")
