...
geturls_opener.addheaders = [("Referer", "http://www.cute-factor.com/general-news/835-more-than-400-miss-bone-emoticons.html"), ("User-Agent", fakeua), ("Accept-Encoding", "gzip, deflate"), ("Accept-Language",
...
il = 11
while(i < il):
    print(str(i)+" Reading URL: http://www.cute-factor.com/imlister.php?cid=missbone&type=e&pp=49&page="+str(i))
    geturls_text = geturls_opener.open(
        "http://www.cute-factor.com/imlister.php?cid=missbone&type=e&pp=49&page="+str(i))
    ...
    while(isub < ilsub):
        ...
        getsub2xurls_opener.addheaders = [("Referer", "http://www.cute-factor.com/imlister.php?cid=missbone&type=e&pp=49&page="+str(i)), ("User-Agent", fakeua), ("Accept-Encoding", "gzip, deflate"), ("Accept-Language",
                                                                                                                                                                                                        "en-US,en-CA,en-GB,en-UK,en-AU,en-NZ,en-ZA,en;q=0.5"), ("Accept-Charset", "ISO-8859-1,ISO-8859-15,utf-8;q=0.7,*;q=0.7"), ("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"), ("Connection", "close")]
        print(str(i)+","+str(isub+1)+" Start Downloading Image File: " +
              str(isub+1)+" of "+str(ilsub))
        print(str(i)+","+str(isub+1)+" Downloading Image: "+post_text[isub][1])
